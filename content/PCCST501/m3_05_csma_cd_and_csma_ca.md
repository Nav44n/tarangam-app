...
**Collision detection, minimum frame size constraint (L_min = 2 * RTT * Bandwidth), exponential backoff, and RTS/CTS handshake.**

<a id="the-intuition"></a>
## 1. The Intuition

::: callout-intuition Core Mental Model
Pedagogical breakdown and intuitive real-world scenario for **CSMA/CD (Ethernet) & CSMA/CA (Wireless)** will be detailed here.
:::
...
What is the core algorithmic objective of CSMA/CD (Ethernet) & CSMA/CA (Wireless)?
...
::: explanation
Detailed pedagogical explanation of why this principle is central to CSMA/CD (Ethernet) & CSMA/CA (Wireless) in Computer Networks.
:::
