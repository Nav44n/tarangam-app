...
You have a tiny dataset of 3 students. You try to predict their test scores out of 100. Calculate the Mean Squared Error (MSE) Cost for your model.

**True Scores ($y$):** [80, 90, 70]
**Model's Predictions ($\hat{y}$):** [75, 90, 78]
...
**Result:** Your model's total Cost is 29.67.
...
Average of $x$ ($\bar{x}$) = \frac{1+2+3}{3} = 2$
 Average of $y$ ($\bar{y}$) = \frac{2+4+5}{3} = 3.67$
...
w_1 = \frac{\text{Numerator}}{\text{Denominator}} = \frac{3.0}{2.0} = 1.5

 w_0 = \bar{y} - w_1\bar{x} = 3.67 - (1.5 \times 2) = 0.67

**Answer:** The best fit line is $\hat{y} = 0.67 + 1.5x$.
...
**Result:** The massive number '2000' is now represented simply as '1.0' (meaning it is exactly 1 standard deviation above average). The algorithm can now compare it safely against the smaller bedroom numbers.
