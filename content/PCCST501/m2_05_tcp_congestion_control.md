...
**AIMD, Slow Start, Congestion Avoidance, Fast Recovery, Tahoe vs Reno, and congestion window (cwnd).**

<a id="the-intuition"></a>
## 1. The Intuition

::: callout-intuition Core Mental Model
Pedagogical breakdown and intuitive real-world scenario for **TCP Congestion Control Algorithms** will be detailed here.
:::
...
What is the core algorithmic objective of TCP Congestion Control Algorithms?
...
::: explanation
Detailed pedagogical explanation of why this principle is central to TCP Congestion Control Algorithms in Computer Networks.
:::
